...
def measure_response_time(url):
    ...
    If there is some kind of a connection problem or HTTP error (like 404),
...
# Indexerror with www.
# different response time for same website
#https://google.com, https://google.com, https://facebook.com
#Got